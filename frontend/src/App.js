  ...
  <span>Action</span>
    ...
    {/* Payment Details Dialog */}
      {showPaymentDetails && selectedPayment && (
        ...
        /* ============================================================================
   FIX: TRADING CHART SINGLE PAGE – NO SCROLLING
   ============================================================================ */
html, body {
  height: 100%;
...
/* Top bars – keep their natural height */
.top-static-user-bar {
  flex-shrink: 0;
}
...
/* Left, center, right panels – scroll internally if needed */
.left-panel,
.center-panel,
.right-panel {
  overflow-y: auto;           /* Allow internal scrolling for long content */
  height: 100%;               /* Fill parent height */
}

/* Center panel – ensure chart container fills available space */
.center-panel {
  display: flex;
  flex-direction: column;
  min-height: 0;
...
.chart-container {
  flex: 1 1 auto;
  min-height: 0;              /* Critical: allows chart to shrink */
  height: auto !important;    /* Override any fixed heights */
}

/* Ensure the TradingView widget itself fills the container */
.tradingview-chart {
  height: 100% !important;
  width: 100% !important;
}

/* If there is a trading controls section below the chart, keep it visible but small */
.trading-controls {
  flex-shrink: 0;
  max-height: 30%;            /* Optional: limit height of order list */
  overflow-y: auto;
}

/* On mobile, you might want to hide some panels to give chart more space */
